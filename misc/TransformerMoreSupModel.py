...
class TransformerMoreSupModel(nn.Module):
    def __init__(self, opt):
        super(TransformerMoreSupModel, self).__init__()
    ...
    def sample_beam(self, att_feats, opt={}):
        ...
        for i in range(self.seq_length + 1):
            ...
            seq_logsofts = self.decoder(dec_partial_seq, dec_partial_pos, output_enc, masks)

...
class TransformerCModel(nn.Module):
    def __init__(self, opt):
        super(TransformerCModel, self).__init__()
    ...
    def forward(self, fc_feats, att_feats, target_seq, masks):
        ...
        output_dec = self.decoder(target_seq, target_pos, fc_feats, att_feats, new_masks)
    ...
    def sample(self, fc_feats, att_feats, opt={}):
        ...
        for i in range(self.seq_length + 1):
            ...
            # target_pos: batch_size * len_dec_1_seq
            dec_partial_pos = np.array([
                [j + 1 for j in range(len_dec_1_seq)]
                for _ in range(batch_size)])
            ...
            if sample_max == 1:
                ...
                # prob_prev: batch_size * (vocab_size + 1)
                # it: batch_size
                it = torch.multinomial(prob_prev, 1)
                # sampleLogprobs: batch_size
    ...
    def sample_beam(self, fc_feats, att_feats, opt={}):
        ...
        for i in range(self.seq_length + 1):
            ...
            # (n_remaining_sents*beam_size) * len_dec_1_seq
            ...
            # size: (n_remaining_sents * beam_size) * len_dec_1_seq

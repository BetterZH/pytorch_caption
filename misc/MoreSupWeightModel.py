...
class MoreSupWeightModel(nn.Module):
    ...
    def forward(self, fc_feats, att_feats, labels):
        ...
        for t in range(self.seq_length + 2):
            ...
            if not can_skip:
                state, logprobs, prob_w = self.core(xt, att_feats, state)
                if t > 0:
    ...
    def sample_forward(self, fc_feats, att_feats, labels, opt={}):
        ...
        for t in range(self.seq_length + 2):
            ...
            state, logprobs, _ = self.core(xt, att_feats, state)
    ...
    def sample_beam(self, fc_feats, att_feats, opt={}):
        ...
        for k in range(batch_size):
            ...
            for t in range(self.seq_length+2):
                ...
                state, logprobs, _ = self.core(xt, beam_att_feats, state)

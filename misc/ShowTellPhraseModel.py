...
class ShowTellPhraseModel(nn.Module):
    def __init__(self, opt):
        super(ShowTellPhraseModel, self).__init__()
        ...
        # word weight linear
        self.prob_weight_layer = nn.Sequential(nn.Linear(self.input_encoding_size, self.vocab_size + 1),
                                         nn.Softmax())
    ...
    def sample_beam(self, fc_feats, opt={}):
        ...
        for k in range(batch_size):
            ...
            prob_weight = self.prob_weight_layer(beam_fc_feats)

...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_path', default='/media/amds/data2/dataset/mscoco/', help='input json file to process into hdf5')
    parser.add_argument('--input_json', default='dataset_coco.json', help='input json file to process into hdf5')
    parser.add_argument('--output_json', default='data_coco.json', help='output json file')
    parser.add_argument('--output_h5', default='data_coco.h5', help='output h5 file')
    parser.add_argument('--output_anno', default='anno_coco.json', help='output anno file')
    ...
    params['input_json'] = os.path.join(params['root_path'], params['input_json'])

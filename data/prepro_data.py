...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_json', default='/home/amds/data1/dataset/caption_datasets/dataset_coco.json', help='input json file to process into hdf5')
    parser.add_argument('--output_json', default='/home/amds/data1/dataset/coco1/data.json', help='output json file')
    parser.add_argument('--output_h5', default='/home/amds/data1/dataset/coco1/data.h5', help='output h5 file')

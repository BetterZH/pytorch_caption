...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='/home/amds/caption/dataset/aic/dataset_aic5.json', help='input json file to process into hdf5')
  parser.add_argument('--dict_json', default='/home/amds/caption/dataset/aic/data_aic5.json', help='output json file')
  parser.add_argument('--output_pkl', default='/home/amds/caption/dataset/aic/aic-train5', help='output pickle file')
